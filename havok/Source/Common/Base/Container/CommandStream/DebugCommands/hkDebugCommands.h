...
{
	HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_NEW_PHYSICS, hkDebugLineCommand);
	hkDebugLineCommand( hkVector4Parameter start, hkVector4Parameter end, hkInt32 color ):
